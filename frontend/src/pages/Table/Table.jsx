    ...
    return (
        <main className="min-h-screen relative overflow-x-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="glass w-full rounded-xl p-8 shadow-2xl">
                    {/* Progress Steps */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                                ...
                                {Array.from({ length: daysInMonth }, (_, i) => i + 1).map((day) => {
                                    ...
                                    return (
                                        <button key={day} disabled={isPast} onClick={() => setSelectedDate(day)}
                                            className={`aspect-square flex items-center justify-center rounded-lg transition-all text-sm ${isPast ? "text-stone-600 cursor-not-allowed" :
                        ...
                        <div className="lg:col-span-5 flex flex-col space-y-8">
                            ...
                            <button onClick={handleReserve}
                                className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 rounded-lg shadow-lg shadow-primary/20 flex items-center justify-center space-x-2 transition-all transform hover:scale-[1.02] active:scale-[0.98]">
