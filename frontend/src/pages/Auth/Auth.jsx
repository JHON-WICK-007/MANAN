            ...
            <div className="w-full lg:w-5/12 flex items-center justify-center p-6 sm:p-12 relative">
                ...
                <div className="w-full max-w-md glass-card p-8 sm:p-10 rounded-xl shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button type="submit"
                            className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-4 rounded-xl shadow-lg shadow-primary/20 transition-colors">
                    ...
                    <div className="mt-8 pt-8 border-t border-stone-700/50">
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <div className="flex space-x-4 w-full">
                                <button className="flex-1 flex items-center justify-center space-x-2 py-3 bg-white/5 border border-stone-700 rounded-xl hover:bg-white/10 transition-colors">
