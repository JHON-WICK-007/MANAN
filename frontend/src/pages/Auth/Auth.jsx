                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="flex items-center justify-center gap-4 px-8">
                                    <button type="button" onClick={() => handleGoogleLogin()} className="w-full flex items-center justify-center py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl transition-all duration-300 gap-3">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg" alt="Google" className="w-[20px] h-[20px]" />
                                        <span className="text-white text-sm font-medium tracking-wide">Continue with Google</span>
                                    </button>
                                </div>
