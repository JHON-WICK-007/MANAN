        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24, width: "100%" }}>
            ...
            <div style={{ position: "relative", width: "100%", height: 240 }}>
                                ...
                                return (
                                    <Cell
                                        ...
                                        style={{
                                            ...
                                            filter: isActive ? `drop-shadow(0 0 6px ${colors[i % 5]}55)` : "none",
                ...
                <div style={{
                    ...
                    >
                        <div style={{ color: centerColor, fontSize: 38, fontWeight: 800, fontFamily: "'Playfair Display', serif", lineHeight: 1, transition: "color 0.4s ease" }}>
                            {centerValue}
                        </div>
                        <div style={{ color: "#444", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginTop: 6 }}>
                            ORDERS
                        </div>
                    </motion.div>
                </div>
                        ...
                        >
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                                <div style={{
                                    ...
                                    boxShadow: isHovered ? `0 0 8px ${colors[i % 5]}` : "none",
                                    transition: "all 0.4s ease",
                                }} />
                                <span style={{
                                    flex: 1, color: isHovered ? "#fff" : "#999",
                                ...
                                <span style={{
                                    color: isHovered ? colors[i % 5] : "#666",
                                    fontSize: 12, fontWeight: 700, flexShrink: 0,
                                    transition: "color 0.4s ease",
                                }}>
                                    {d.count} <span style={{ fontWeight: 400, color: "#444", fontSize: 11 }}>({pct}%)</span>
                                </span>
                            </div>
                            {/* Progress bar */}
                            <div style={{ height: 3, borderRadius: 99, background: "rgba(255,255,255,0.05)", overflow: "hidden" }}>
                                <div style={{
                                    ...
                                    background: isHovered
                                        ? `linear-gradient(90deg, ${colors[i % 5]}, ${colors[i % 5]}88)`
                                        : `${colors[i % 5]}44`,
                                    boxShadow: "none",
                                    transition: "all 0.4s ease",
                                }} />
                ...
                <Card title="Revenue" delay={0.28} right={
                    ...
                    <ResponsiveContainer width="100%" height={260}>
                        <AreaChart data={trendData} margin={{ top: 8, right: 0, left: -10, bottom: 0 }}>
                            ...
                            <Tooltip content={<CustomTooltip />} position={{ y: 16 }} allowEscapeViewBox={{ x: false, y: false }} cursor={{ stroke: "rgba(16,185,129,0.12)", strokeWidth: 1, strokeDasharray: "4 4" }} />
                ...
                <Card title="Orders & Reservations" delay={0.35} right={
                    ...
                    <ResponsiveContainer width="100%" height={260}>
                        <AreaChart data={trendData} margin={{ top: 8, right: 0, left: -20, bottom: 0 }}>
                            ...
                            <Tooltip content={<CustomTooltip />} position={{ y: 16 }} allowEscapeViewBox={{ x: false, y: false }} cursor={{ stroke: "rgba(255,255,255,0.08)", strokeWidth: 1, strokeDasharray: "4 4" }} />
