...
const Home = () => {
    ...
    return (
        <div>
            ...
            {/* ───── Chef's Specials ───── */}
            <section className="py-32 px-4 md:px-20 overflow-hidden">
                ...
                <div className="flex gap-8 overflow-x-auto pb-12 hide-scrollbar snap-x snap-mandatory">
                    {specials.map((item) => (
                        <div key={item._id} className="min-w-[320px] md:min-w-[420px] snap-center group" style={{ transition: "transform 0.4s ease", willChange: "transform" }} onMouseEnter={e => e.currentTarget.style.transform="scale(1.03) translateY(-6px)"} onMouseLeave={e => e.currentTarget.style.transform="scale(1) translateY(0)"}>
                            <div className="relative h-[500px] rounded-2xl overflow-hidden glass p-4 transition-all duration-500" style={{ transform: "translateZ(0)" }}>
                                {item.image && (
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-16 items-center">
                    <div className="relative order-2 md:order-1">
                        <div className="relative z-10 rounded-2xl overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=800&q=80" alt="Chef working"
                        ...
                        <div className="absolute bottom-8 -right-12 glass p-8 rounded-xl max-w-xs hidden lg:block">
                            <p className="italic text-stone-300 font-light mb-4">"Cooking is a craft, a pursuit of perfection that never truly ends."</p>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-primary text-xs uppercase tracking-widest">Executive Chef</p>
                                </div>
                            </div>
                        </div>
                    </div>
